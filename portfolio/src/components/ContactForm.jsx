...
export default function ContactForm() {
  ...
  return (
    <section id="contact" className="relative w-full py-32 md:py-60 bg-white text-black overflow-hidden">
      <div className="relative z-10 section-wrap px-8 md:px-24 max-w-7xl mx-auto">
        ...
        <div className="mb-24 md:mb-40">
            ...
            >
              <h2 className="text-7xl md:text-[10rem] font-black tracking-tighter leading-[0.8] uppercase flex flex-col md:flex-row md:items-baseline gap-4">
                Let's Talk <span className="text-black/5 italic font-serif lowercase translate-y-[-0.1em]">.</span>
              </h2>
              <p className="mt-8 text-black/40 text-lg font-medium tracking-tight">Available for definitive digital collaborations.</p>
            </motion.div>
        </div>
              ...
              {submitted ? (
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-between py-16 md:py-24 gap-12 border-t border-black/5">
                    ...
                    >
                      <span className="text-3xl md:text-7xl font-black uppercase tracking-tighter group-hover:translate-x-4 transition-transform duration-700">
                        Send Transmission
                      </span>

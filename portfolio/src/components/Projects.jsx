    ...
    >
      <div className="relative z-10 w-full section-wrap px-8 md:px-24 max-w-[100rem]">
        ...
        >
          ...
          <div className="mt-64 flex items-center justify-center gap-4 md:gap-10 text-black/5 select-none w-full overflow-hidden">
            <Code2 size={16} />
            <span className="text-[28px] md:text-[60px] font-black uppercase tracking-tighter truncate max-w-full">Athletic_Code</span>
            <Code2 size={16} />
          </div>
        </motion.div>
      </div>
